webpackJsonp([2], [
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        function main(initialHmrState) {
            return platform_browser_dynamic_1.bootstrap(app_1.App, browser_1.PROVIDERS.concat(browser_1.DIRECTIVES, [
                environment_1.ENV_PROVIDERS
            ], browser_1.PIPES))
                .then(function (appRef) {
                    // store a reference to the application injector
                    app_utils_1.setInjector(appRef.injector);
                })
                .catch(function (err) {
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        var TableView = (function () {
            ...
            TableView.prototype.changeFilter = function (data, config) {
                ...
                for (var i = 0; i < filterKeys.length; i++) {
                    ...
                    data = data.filter(function (item) {
                        var calculatedItem = filterKey.split(".").reduce(function (a, b) {
                            return a ? a[b] : "";
                        }, item);
            ...
            TableView.prototype.onChangeTable = function (config) {
                ...
                var sortedData = this.changeSort(filteredData, this.tableBuilder);
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        var TableCell = (function () {
            function TableCell(loader, elementRef) {
                this.loader = loader;
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        var TableDataPipe = (function () {
            ...
            TableDataPipe.prototype.transform = function (value, col) {
                if (col === void 0) {
                    col = null;
                }
